                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id voluptatem tempore quae, cum consequatur <a href="#">quisquam totam</a>, facilis illo blanditiis. Voluptatem dolores eius, quam sequi labore impedit id repellat deserunt autem.</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <a href="#">Id voluptatem tempore quae</a>, cum consequatur quisquam totam, facilis illo blanditiis. Voluptatem dolores eius, quam sequi labore impedit id repellat deserunt autem.</p>
                        </div>
                                ...
                                <div class="panel-heading noPd">
                                    <ul class="nav nav-tabs nav-justified">
                                        <li role="presentation" class="dropdown active">
                                            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" style="cursor:pointer">Im&aacute;genes <span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="#tab2011" data-toggle="tab">Año 2011</a></li>
                                        ...
                                        <li><a href="#tabAvances" data-toggle="tab">Fotos Avance</a></li>
                                        ...
                                        <div class="tab-pane fade in" id="tab2011">
                                            <div id="carousel-b" class="carousel slide" data-ride="carousel">
                                                <div class="carousel-inner" role="listbox">
                                                    ...
                                                    <div class="item">
                                                        <a href="fotos/foto-render01.jpg" class="lytebox" data-lyte-options="group:fotos2011" data-title="Foto 2"><img src="http://placehold.it/720x350?text=FOTO+AÑO+2011"></a>
                                                    </div>
                                                </div>
                                                <!--/carousel-inner-->
                                                <!-- Controls -->
                                        ...
                                        <div class="tab-pane fade in" id="tab2014">
                                            <div id="carousel-d" class="carousel slide" data-ride="carousel">
                                                <div class="carousel-inner" role="listbox">
                                                    ...
                                                    <div class="item">
                                                        <!--<a href="fotos/2014/video2014-01.mp4" class="lytebox" data-lyte-options="group:fotos2014" data-title="Video 1" ><img src="fotos/2014/video2014-01-t.jpg"></a>-->
                                                        <video controls="controls" width="300" height="150" poster="video2014-01-t.jpg" autobuffer autoplay>
                                                            <source src="video2014-01.mp4" type="video/mp4">
                                                            <source src="video2014-01.ogg" type="video/ogg">
                                                            <source src="video2014-01.webm" type="video/webm">
                                                            Tu navegador no soporta video HTML5
                                                        </video>
                                                    </div>
                                                    <div class="item">
                                                        <!-- <a href="fotos/2014/video2014-02.mp4" class="lytebox" data-lyte-options="group:fotos2014" data-title="Video 2" ><img src="fotos/2014/video2014-02-t.jpg"></a>-->
                                                        <video controls="controls" width="300" height="150" poster="video2014-01-t.jpg" autobuffer autoplay>
                                                            <source src="video2014-02.mp4" type="video/mp4">
                                                            <source src="video2014-02.ogg" type="video/ogg">
                                                            <source src="video2014-02.webm" type="video/webm">
                                                            Tu navegador no soporta video HTML5
                                                        </video>
                                                    </div>

...
<footer class="section" id="footer">
    <div class="container">
        <div class="row">
            <article class="col-md-6 rss">
                <h2 class="media-heading text-inverse">Blog</h2>
              <?php
              // Include WordPress
              ...
              query_posts('showposts=1');
                ...
                <?php while (have_posts()): the_post(); ?>
                   <h3><?php the_title(); ?></h3>
                   <small><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> <?php the_date(); ?></small>
                   <?php the_post_thumbnail(array( 150,150 ), array('class' => 'img-responsive img-thumbnail pull-right ')); ?>
                   <?php the_excerpt(); ?>
                   <p><a href="<?php the_permalink(); ?>" class="btn btn-sm">Ver m&aacute;s...</a></p>
                <?php endwhile; ?>
            </article>
            <div class="col-md-4 bd-dotted">
                <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Flagosdelleyes%2F&tabs=timeline&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=true&show_facepile=false&appId=609109702454596" width="100%" height="264" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
            </div>
            <div class="col-md-2 bd-dotted">
                <p class="clearfix">Comercializan:
                    <br>
